...
{
#if DEBUG
    public static readonly double ActivityTimeoutIntervalInMilliseconds = 1000 * 20; // 1/4 minute
...
#else
        public static readonly double ActivityTimeoutIntervalInMilliseconds = 1000 * 60 * 2; // two minute
